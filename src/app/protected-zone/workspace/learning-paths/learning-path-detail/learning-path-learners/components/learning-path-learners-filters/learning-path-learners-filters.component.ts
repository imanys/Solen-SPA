...
import {LearnerForLearningPathDto} from 'src/app/models';


@Component({
  selector: 'app-learning-path-learners-filters',
  styleUrls: ['learning-path-learners-filters.component.scss'],
...
export class LearningPathLearnersFiltersComponent implements OnInit {
  ...
  ngOnInit(): void {
    this.filterSelectObj.filter((o) => {
      o.options = this.getFilterObject(this.learners, o.columnProp);
    });
  }
