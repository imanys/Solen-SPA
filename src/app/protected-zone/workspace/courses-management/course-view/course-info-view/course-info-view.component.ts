...
@Component({
  selector: 'app-course-info-bootstrap',
  styleUrls: ['course-info-view.component.scss'],
  changeDetection: ChangeDetectionStrategy.OnPush,
  template: `
    <section>
      <app-go-back-button (clicked)="onGoBackClick()"> </app-go-back-button>
      <app-course-info-view></app-course-info-view>
...
export class CourseInfoViewComponent {
  navLinks: any[];
  activeLinkIndex = 0;
